...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private final UnitOfMesaureRepository unitOfMeasureRepository;

    public DataLoader(CategoryRepository categoryRepository, RecipeRepository recipeRepository, UnitOfMesaureRepository unitOfMeasureRepository) {
